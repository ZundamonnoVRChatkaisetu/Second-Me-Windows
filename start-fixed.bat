...
echo.
echo  ================================================
echo    Second-Me Windows - Fixed Startup Script
echo  ================================================
echo.
...
:: 4. Configure frontend to connect to CORS proxy
...
echo.
echo  エラーが発生した場合の対応:
echo  1. lpm_frontend\reinstall-deps.bat を実行して依存関係を再インストール
echo  2. 再起動しても問題が解決しない場合は GitHub の Issues を参照
echo.
